    ...
    <div className="min-h-screen bg-[#F8F9FA] text-black font-sans p-6 md:p-10">
      ...
      {successToast && (
        ...
        >
          ...
          <button onClick={() => setSuccessToast('')} className="text-zinc-500 hover:text-black">✕</button>
        </motion.div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <motion.div
          ...
          className={`cursor-pointer p-6 rounded-3xl border transition-all ${
            filterStatus === 'Pending'
              ...
              : 'bg-white shadow-xl/90 border-gray-200'
          }`}
        >
          ...
          <div className="text-xs text-gray-500 mt-2">Requires Manager Review</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-4xl font-black text-black">{approvedCount}</div>
          <div className="text-xs text-gray-500 mt-2">Deducted from Employee Balances</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-4xl font-black text-black">{rejectedCount}</div>
          <div className="text-xs text-gray-500 mt-2">Dismissed Applications</div>
        </motion.div>
      </div>
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-full font-bold text-sm transition-all ${
              filterStatus === status
                ...
                : 'bg-white shadow-xl text-gray-500 hover:text-black border border-gray-200'
            }`}
          >
            {status} Requests
          </button>
      ...
      <div className="space-y-4">
        {filteredRequests.length === 0 ? (
          <div className="bg-white shadow-xl/50 border border-gray-200 p-12 rounded-3xl text-center text-zinc-500 italic">
          ...
          filteredRequests.map((req) => {
            ...
            return (
              <motion.div
                ...
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-white shadow-xl/90 border border-gray-200 hover:border-gray-200 p-6 md:p-8 rounded-3xl backdrop-blur flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6"
              >
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="px-3 py-1 bg-gray-50 text-zinc-300 rounded-full text-xs font-bold">
                      {req.leaveType} Leave
                    </span>
                  ...
                  <div className="text-sm text-gray-500 font-medium">
                    Duration: <span className="text-black font-bold">{req.startDate}</span> to{' '}
                    <span className="text-black font-bold">{req.endDate}</span>
                  </div>

                  <div className="text-sm text-zinc-300 bg-zinc-950 p-4 rounded-2xl border border-gray-200/80 mt-2">
                ...
                {req.status === 'Pending' && (
                  <div className="flex gap-3 w-full lg:w-auto">
                    ...
                    <button
                      ...
                      className="flex-1 lg:flex-none px-6 py-3 bg-rose-500/10 hover:bg-rose-500 text-rose-400 hover:text-black font-bold rounded-2xl border border-rose-500/30 transition-all"
                    >
                      Reject
                    </button>
                  </div>
        ...
        {selectedRequest && actionType && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-white shadow-xl border border-gray-200 p-8 rounded-3xl w-full max-w-md relative"
            >
              <button
                onClick={() => {
                  setSelectedRequest(null);
              ...
              <p className="text-sm text-gray-500 mb-6">
                ...
                <span className="text-black font-bold">{selectedRequest.leaveType} leave</span>{' '}
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-gray-50 border border-gray-200 text-black rounded-xl p-3 text-sm outline-none focus:border-pink-500"
                />
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-gray-50 text-zinc-300 font-bold text-sm"
                >
                  Cancel
                </button>
                <button
